...
public class PlayerSearchQueries {
	...
	public static final String GETPLAYERSBYAGE = "select id, name, gender, teamname, contact from roc_revature.player where age = ?";
	public static final String GETPLAYERBYCONTACT = "select id, name, gender, teamname, age from roc_revature.player where contact = ?";
	public static final String GETPLAYERSBYTEAMNAME = "select id, name, gender, contact, age from roc_revature.player where teamname = ?";
}
