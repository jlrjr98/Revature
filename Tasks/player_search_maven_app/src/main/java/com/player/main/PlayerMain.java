	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				} catch (NumberFormatException e) { //If user tries to input a String
			...
			case 3:
				...
				try {
					...
					System.out.println("Age should be number only.. Kindly Re-enter");
				} catch (BusinessException e) {
					System.out.println(e.getMessage());
				}
			...
			case 4:
				...
				break;
			case 5:
				System.out.println("Please enter contact to get the Player with that contact ");
				...
				try {
					...
					if(player!=null && contact>0) {
						System.out.println("We Found a player in the DB..with contact "+contact+" Details are");
				...
				break;
			case 6:
				System.out.println("Please enter Team Name to get the Players of that Team ");
				...
				try {
					...
					if (playersListTeamName != null && playersListTeamName.size() > 0) {
						System.out.println("We Found "+playersListTeamName.size()+" no of player/s in the DB..with Team Name "+teamName+" Details are");
			...
			case 7:
				...
				break;
			case 8:
				System.out.println("Thank YOU for using Vinay's Player Search App V2.0... We would expect you back very soon :)");
